...
path(
    'legacy/search/', LegacyAccountSearchView.as_view(        action_url_name='transact1_regular_deposit:legacy-import',
        button_text='Import',  button_color='warning',    title='Legacy– Search Member Account'  ),
    name='legacy-search'),

path(  'legacy/<int:account_id>/', LegacyAccountImportView.as_view(), name='legacy-import'),
